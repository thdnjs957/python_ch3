...
urlpatterns = [
    path('emaillist/', emaillist_views.index), # url , index 라는 함수
    ...
    path('helloworld/counter/max', helloworld.views.counter_max),
    path('helloworld/counter/add', helloworld.views.counter_add),
    path('helloworld/counter/update', helloworld.views.counter_update),
